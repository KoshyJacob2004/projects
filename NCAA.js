...
const url = "https://www.vegasinsider.com/college-football/odds/las-vegas/";
...
export const ncaa = async () => {
    ...
    // await page.waitForXPath('//*[@id="odds-component"]/div/ul/li[2]/span');
    // // evaluate XPath expression of the target selector (it return array of ElementHandle)
    // let elHandle = await page.$x('//*[@id="odds-component"]/div/ul/li[2]/span');

    await page.click('#odds-component > div > ul > li:nth-child(3) > span');
...
for(let i = 0; i < Object.keys(betDataFull).length/2; i++) {
    for(let g = 0; g < 8; g++) {
    ...
    for(let v = 0; v < 8; v++) {
        ...
        if (result) {
            ...
            console.log(topValueInt, bottomValueInt, "\n")
